...
# wait
srun Rscript ./R_scripts/seurat2monocle.R $source_files 0
wait
srun Rscript ./R_scripts/seurat_dimreduc.R $source_files 1
wait
srun Rscript ./R_scripts/monocle_dimreduc.R $source_files 2
wait
