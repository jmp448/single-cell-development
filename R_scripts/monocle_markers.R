...
png("./monocle_plots/stem_cell_markers.png", width=800, height=600)
...
png("./monocle_plots/mesoderm_markers.png", width=800, height=600)
...
png("./monocle_plots/progenitor_markers.png", width=800, height=600)
...
png("./monocle_plots/cardiomyocyte_markers.png", width=800, height=600)
...
png("./monocle_plots/myofibroblast_markers.png", width=800, height=600)
...
png("./monocle_plots/epicardium_markers.png", width=800, height=600)
...
png("./monocle_plots/fibroblast_markers.png", width=800, height=600)
