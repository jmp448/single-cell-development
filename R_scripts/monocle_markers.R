...
png("./monocle_plots/markers_stem_cell.png", width=800, height=600)
...
png("./monocle_plots/markers_mesoderm.png", width=800, height=600)
...
png("./monocle_plots/markers_cardiomyocyte.png", width=1800, height=600)
...
png("./monocle_plots/markers_epicardium.png", width=800, height=600)
...
png("./monocle_plots/fibroblast_markers.png", width=1800, height=600)
