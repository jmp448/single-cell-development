...
# PCA diffday
png(paste0(plots_loc, "old_lowpass_sctransform_PCA_diffday.png"), width=800, height=600)
PCAPlot(sc, group.by="diffday")
dev.off()

# PCA individual
png(paste0(plots_loc, "old_lowpass_sctransform_PCA_indiv.png"), width=800, height=600)
PCAPlot(sc, group.by="individual")
dev.off()

# PCA collection
png(paste0(plots_loc, "old_lowpass_sctransform_PCA_col.png"), width=800, height=600)
PCAPlot(sc, group.by="orig.ident")
dev.off()

# PCA colday
png(paste0(plots_loc, "old_lowpass_sctransform_PCA_colday.png"), width=800, height=600)
PCAPlot(sc, group.by="colday")
dev.off()

# UMAP diffday
png(paste0(plots_loc, "old_lowpass_sctransform_UMAP_diffday.png"), width=800, height=600)
DimPlot(sc, group.by="diffday")
dev.off()

# UMAP individual
png(paste0(plots_loc, "old_lowpass_sctransform_UMAP_indiv.png"), width=800, height=600)
DimPlot(sc, group.by="individual")
dev.off()

# UMAP collection
png(paste0(plots_loc, "old_lowpass_sctransform_UMAP_col.png"), width=800, height=600)
DimPlot(sc, group.by="orig.ident")
dev.off()

# UMAP colday
png(paste0(plots_loc, "old_lowpass_sctransform_UMAP_colday.png"), width=800, height=600)
...
#
# # PCA individual
# png(paste0(plots_loc, "lowpass_sctransform_mitoregress_PCA_indiv.png"), width=800, height=600)
# PCAPlot(sc, group.by="individual")
# dev.off()
#
# # PCA collection
# png(paste0(plots_loc, "lowpass_sctransform_mitoregress_PCA_col.png"), width=800, height=600)
# PCAPlot(sc, group.by="orig.ident")
# dev.off()
#
# # PCA colday
...
#
# # UMAP individual
# png(paste0(plots_loc, "lowpass_sctransform_mitoregress_UMAP_indiv.png"), width=800, height=600)
# DimPlot(sc, group.by="individual")
# dev.off()
#
# # UMAP collection
# png(paste0(plots_loc, "lowpass_sctransform_mitoregress_UMAP_col.png"), width=800, height=600)
# DimPlot(sc, group.by="orig.ident")
# dev.off()
#
# # UMAP colday
