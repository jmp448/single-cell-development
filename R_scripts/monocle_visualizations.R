...
# plot_cells(m, reduction_method="PCA", color_cells_by="orig.ident", label_cell_groups=F)
# dev.off()
...
# plot_cells(m, reduction_method="UMAP", color_cells_by="orig.ident", label_cell_groups=F)
# dev.off()
...
# plot_cells(m, reduction_method="PCA", color_cells_by="orig.ident", label_cell_groups=F, norm_method="size_only")
# dev.off()
...
# plot_cells(m, reduction_method="UMAP", color_cells_by="orig.ident", label_cell_groups=F, norm_method="size_only")
# dev.off()
...
m <- readRDS("./rds_objects/monocle_from_seurat_fulldata_sctransform_mitoregress_processed.RDS")
png(paste0(plots_loc, "fulldata_sctransform_mitoregress_PCA_diffday.png"), width=800, height=600)
plot_cells(m, reduction_method="PCA", color_cells_by="diffday", label_cell_groups=F, norm_method="size_only")
dev.off()
png(paste0(plots_loc, "fulldata_sctransform_mitoregress_PCA_individual.png"), width=800, height=600)
plot_cells(m, reduction_method="PCA", color_cells_by="individual", label_cell_groups=F, norm_method="size_only")
dev.off()
png(paste0(plots_loc, "fulldata_sctransform_mitoregress_PCA_collection.png"), width=800, height=600)
plot_cells(m, reduction_method="PCA", color_cells_by="orig.ident", label_cell_groups=F, norm_method="size_only")
dev.off()
...
plot_cells(m, reduction_method="UMAP", color_cells_by="diffday", label_cell_groups=F, norm_method="size_only")
dev.off()
png(paste0(plots_loc, "fulldata_sctransform_mitoregress_UMAP_individual.png"), width=800, height=600)
plot_cells(m, reduction_method="UMAP", color_cells_by="individual", label_cell_groups=F, norm_method="size_only")
dev.off()
png(paste0(plots_loc, "fulldata_sctransform_mitoregress_UMAP_collection.png"), width=800, height=600)
plot_cells(m, reduction_method="UMAP", color_cells_by="orig.ident", label_cell_groups=F, norm_method="size_only")
dev.off()
